angular.module('your_app_name.app.controllers', [])
    ...
    .controller('HomeCtrl', function ($scope, $rootScope, ExchangesRateService, $ionicModal, currencyFormatService, $timeout, AuthService, ExchangeService, googleMapService, $stateParams, $state) {
        $scope.exchangesRate = [];
        $scope.dataExchange = {};
