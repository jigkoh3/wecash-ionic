...
.controller('HomeCtrl', function($scope, $rootScope, ExchangesRateService, $ionicModal, currencyFormatService, $timeout, AuthService, ExchangeService, googleMapService, $stateParams, $state, $cordovaGeolocation) {
    $scope.exchangesRate = [];
    $scope.dataExchange = {};
